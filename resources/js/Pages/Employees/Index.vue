    ...
    <AuthenticatedLayout>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <table class="w-full text-sm text-left">
                        <thead
                            class="text-xs text-zinc-50 uppercase bg-neutral-800"
                        >
                            <tr>
        ...
        <Modal :show="showQRModal" @close="closeQRModal" maxWidth="sm">
            <div class="mx-10 mb-5 flex justify-center items-center">
                <img class ="mt-10" :src="selectedEmployee.qr" alt="Girl in a jacket" width="300" height="300">
            </div>
